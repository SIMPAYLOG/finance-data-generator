...
public class UserAnalyzeTest extends TestConfig {
    ...
    void setup() {
        ...
        userRepository.saveAll(
                List.of(
                        User.of(sessionId, "김민준", UserBehaviorProfile.of(new BigDecimal("5500000"), 1, WageType.DAILY, 25), 8, 30, Gender.M, new BigDecimal("15000000"), 1, 1, "소프트웨어 엔지니어", 1),
                        User.of(sessionId, "김민주", UserBehaviorProfile.of(new BigDecimal("5500000"), 1, WageType.DAILY, 25), 8, 20, Gender.F, new BigDecimal("15000000"), 1, 2, "소프트웨어 엔지니어", 1),
                        User.of(sessionId, "김철수", UserBehaviorProfile.of(new BigDecimal("5500000"), 2, WageType.DAILY, 25), 8, 40, Gender.M, new BigDecimal("15000000"), 1, 2, "소프트웨어 엔지니어", 1),
                        User.of(sessionId, "최민수", UserBehaviorProfile.of(new BigDecimal("5500000"), 1, WageType.DAILY, 25), 8, 50, Gender.M, new BigDecimal("15000000"), 1, 1, "소프트웨어 엔지니어", 1),
                        User.of(sessionId, "민철승", UserBehaviorProfile.of(new BigDecimal("5500000"), 2, WageType.DAILY, 25), 8, 60, Gender.M, new BigDecimal("15000000"), 1, 2, "소프트웨어 엔지니어", 1),
                        User.of(sessionId, "한지혜", UserBehaviorProfile.of(new BigDecimal("5500000"), 2, WageType.DAILY, 25), 8, 70, Gender.F, new BigDecimal("15000000"), 1, 1, "소프트웨어 엔지니어", 1),
                        User.of(sessionId, "금민", UserBehaviorProfile.of(new BigDecimal("5500000"), 1, WageType.DAILY, 25), 8, 20, Gender.M, new BigDecimal("15000000"), 1, 2, "소프트웨어 엔지니어", 1),
                        User.of(sessionId, "김지영", UserBehaviorProfile.of(new BigDecimal("5500000"), 2, WageType.DAILY, 25), 8, 10, Gender.F, new BigDecimal("15000000"), 1, 1, "소프트웨어 엔지니어", 1),
                        User.of(sessionId, "강혜지", UserBehaviorProfile.of(new BigDecimal("5500000"), 2, WageType.DAILY, 25), 8, 50, Gender.F, new BigDecimal("15000000"), 1, 1, "소프트웨어 엔지니어", 1),
                        User.of(sessionId, "이지민", UserBehaviorProfile.of(new BigDecimal("5500000"), 2, WageType.DAILY, 25), 8, 70, Gender.F, new BigDecimal("15000000"), 1, 2, "소프트웨어 엔지니어", 1)
                )
        );
    }
